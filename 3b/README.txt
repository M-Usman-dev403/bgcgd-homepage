BGCGD Homepage — Direction 3b (light)
=====================================
...
TO PUT IT ON GITHUB PAGES
  ...
  To host 3a and 3b side by side, put each in its own folder:
    /3a/index.html  ->  yoursite.github.io/repo/3a/
    /3b/index.html  ->  yoursite.github.io/repo/3b/
